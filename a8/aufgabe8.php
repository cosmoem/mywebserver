...
<head>
   ...
   */
    ...
    require_once '../.passwd.inc.php';
   	...
   	$dbh = new DB('_s0563166__mockupdatadb', 'db.f4.htw-berlin.de:3306', 's0563166', $password); /*PASSWORT AUSLAGERN!!*/
         ...
         <div class="panel-body">
            ...
            <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
             ...
             -->
              ...
              <input class="form-control" type="hidden" name="id" value="<?php echo $teilnehmerin['id'] ?>" />
           	...
           	<div class="row">
           		<div class="col-xs-12">
            		<form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                        ...
                        <input class="form-control" type="text" name="ipnr" placeholder="IP-Adresse" />
